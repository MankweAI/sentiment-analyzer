...
export default function AddNewProspect() {
  ...
  const LeakDropdown = ({ name, label }) => (
    <div className="flex flex-col">
      ...
      <select id={name} name={name} value={formData[name]} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-primary-dark focus:border-primary-dark">
